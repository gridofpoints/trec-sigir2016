%% threeFactorMainEffectsPlot
% 
% Computes the main effects plots for a three factors, mixed effects, 
% repeated measures GLMM considering topics as random factor and system 
% components as fixed factors.

%% Synopsis
%
%   [] = threeFactorMainEffectsPlot(measures, measureShortName, trackID, list)
%  
% *Parameters*
%
...
function [] = threeFactorMainEffectsPlot(measures, measureShortName, trackID, lugType)
    ...
    currentFigure = figure('Visible', 'on');
       ...
       % figureID = EXPERIMENT.pattern.identifier.figure.mainEffects(measureShortName, lugType, trackID);
